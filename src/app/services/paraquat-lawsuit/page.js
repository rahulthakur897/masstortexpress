...
export default function ParaquatLawsuit() {
  return (
    <main>
      ...
      >
        <div className="w-full md:w-[60%]">
          ...
          <div>
            <p className="p-[1em]">
              ...
              researchers performing the agricultural health study found
              Paraquat was assosciated with Parkinson's disease. People who came
              into contact with Paraquat were twice as likely to get the disease
              as someone with no exposure to it.{" "}
            </p>
            <p className="p-[1em]">
              Paraquat is a highly toxic herbicide used extensively in the
              United States since the 1960s. Scientific evidence has established
              a strong link between long-term exposure to Paraquat and the
              development of Parkinson's disease, a devastating neurological
              condition. As a result, numerous lawsuits have been filed against
              the manufacturers of this chemical, alleging that they failed to
              warn consumers about the risks. Paraquat posioning has caused two
              to three deaths per years, handling it calls for special training.
              Even when handlded as instructed, there are claims of it being
              dangerous.
            </p>
            ...
            <ul className="list-disc pt-[0.5rem] px-[2rem]">
              <li className="p-1">
                <strong>Time Period:</strong> When did the exposure occur? Was
                it after 1964 and before developing the medical condition?{" "}
              </li>
              <li className="p-1">
              ...
              <li className="p-1">
                ...
                doctor's statements, or other documentation that support the
                link between your exposure and your illness?{" "}
              </li>
            </ul>
          </div>
        </div>
        <div className="relative md:absolute md:-top-[8rem] md:right-0 w-full md:w-[40%] bg-transparent md:bg-white md:shadow-lg md:rounded-2xl p-6 md:p-8 max-w-xl mx-auto">
          <ContactForm formType="ParaquatLawsuit" />
        </div>
      </section>
      {/*section 3*/}
      ...
      <section className="relative text-[#000] py-2 w-[95%] md:w-[90%] m-auto">
        <h3 className="text-xl sm:text-2xl md:text-[1.75rem] text-[#000e30] pb-3 font-bold">
          ...
          <span className="text-[#439E30]">Paraquat class action ?</span>
        </h3>
        <ul className="list-disc pt-[0.5rem] px-[2rem]">
          <li className="p-1">
        ...
        <h3 className="text-xl sm:text-2xl md:text-[1.75rem] text-[#000e30] py-8 pb-3 font-bold">
          Common Conditions Linked to Paraquat and{" "}
          <span className="text-[#439E30]">
            Parkinson disease Class Action:
          </span>
        </h3>
